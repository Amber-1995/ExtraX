	...
	_pixel_shader(nullptr)
{
	...
	vertex[0].position = XXVector3(0.0f, 0.0f, 0.0f);
	...
	vertex[1].position = XXVector3(200.0f, 0.0f, 0.0f);
	...
	vertex[2].position = XXVector3(0.0f, 200.0f, 0.0f);
	...
	vertex[3].position = XXVector3(200.0f, 200.0f, 0.0f);
